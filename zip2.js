...
// })
    ...
    //getting second database file
		const newfile =computernew+path2+'/'+newsubstring +"/3d0d7e5fb2ce288813306e4d4636395e047a3d28";
		...
		for (var sj = 0; sj < data2.length; sj++) {
			newrecord+='<div class="data_p21" data-id="'+data2[sj].ROWID+'"><img class="msg_img" src="images/person_new.png"><span class="messages_export phone_number">'+data2[sj].chat_identifier+"</span></div>";
		...
		var myFunction = function () {
			...
			for (var sj1 = 0; sj1 < data3.length; sj1++) {
				...
				if (data3[sj1].is_from_me != 0) {
					newy+='<div class="right_msg"><p>'+data3[sj1].text+"</p><span>"+newdate+"</span> <span>11:04</span></div>";
				} else {
					newy+='<div class="left_msg"><p>'+data3[sj1].text+"</p><span>"+newdate+"</span> <span>11:04</span></div>";
				}
			}
...
document.getElementById("facebook_msg").addEventListener("click",function () {
